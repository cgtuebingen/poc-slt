...
if __name__ == "__main__":
    eval_dir = "/graphics/scratch2/staff/zakeri/train_logs/Transformer/flash_attention/with_optimized_latent_codes/full_dataset/overfitting/clean_code/regular_cat_fulldataset_alternative_test3_normalized_shapenet_noEmptymasking_custom/eval/ev0/front_bottom_right_octant/eval_dir/"
    ...
    print()
    extract_metric_results(eval_dir, "front_bottom_right_octantcd_eval_results", broken_object_index_all_read, combined_pickles)
    print()
    extract_per_class_eval_results(eval_dir, "front_bottom_right_octant_eval_results", broken_object_index_all_read, combined_pickles)
    print()
