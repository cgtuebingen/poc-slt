...
def main_bottom_half(eval_mode_dir: str, obj_dir: str, common_obj_dir: str, checkpoint_mode_path: str):
    ...
    from Transformer.Attention.TransformerEval_revised.evaluation_approaches.Shapenet_normalized.Trans_NonOptimized.configs.custom_no_empty_masking.eval_shapenet import EVALShapenetVal
...
if __name__ == "__main__":
    ...
    main_bottom_half(eval_dir, obj_dir, common_obj_dir, checkpoint_mode_path)
