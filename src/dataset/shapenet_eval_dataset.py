...
class ShapeNetcorev1NormalizedValWithNonOptimizedLatentCodes(pl.LightningDataModule):
    ...
    def __getitem__(self, idx: int):
        ...
        with self.my_lmdb.begin(
            ...
            mesh_file_name = str(raw_example["mesh_file_name"])
    ...
    def extract_new_mesh_file_names(self, mesh_file_name: str):
        ...
        sub_name = mesh_file_name.replace(
            common_pattern1, ""
        )  # "04090263/e32501e54d05abf4f1b2b421ee7abb94/models/model_normalized.obj.obj"

        common_pattern2 = "model_normalized.obj.obj"
        sub_sub_name = sub_name.replace(
            common_pattern2, ""
        )  # "04090263/e32501e54d05abf4f1b2b421ee7abb94/models"
        ...
        new_mesh_file_name = os.path.join(
            new_pattern, sub_sub_name + "model_normalized.obj"
        )
