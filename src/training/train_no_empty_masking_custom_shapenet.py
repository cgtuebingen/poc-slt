...
from src.dataset.shapenet_train_dataset import ShapeNetcorev1NormalizedTrainWithNonOptimizedLatentCodes  # train

from src.dataset.shapenet_eval_dataset import ShapeNetcorev1NormalizedValWithNonOptimizedLatentCodes  # val
...
#     # # # v9 it seems v8 is not fully convergeed we train it for another 200 epochs only
#
# #
