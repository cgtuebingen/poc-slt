...
class FVSEncoder(pl.LightningModule):
    ...
    def __init__(self, params_encoder, latent_dim: int):
        ...
        if (params_encoder is not None):
            ...
            self.convblock1 = sc.ConvBlock(ch_in=1, ch_out=32, k_size=3, s_size=1, p_size=1)
            self.convblock1_1 = sc.ConvBlock(ch_in=32, ch_out=32, k_size=3, s_size=1, p_size=1)

            self.convblock2 = sc.ConvBlock(ch_in=32, ch_out=32, k_size=3, s_size=1, p_size=1)
            self.convblock2_1 = sc.ConvBlock(ch_in=32, ch_out=32, k_size=3, s_size=1, p_size=1)

            self.maxpool2 = nn.MaxPool3d(3, stride=2, padding=1)
            self.sk2 = nn.Conv3d(32, 32, kernel_size=3, stride=2, padding=1)
            #----------------------------------------------------------------------
            self.convblock3 = sc.ConvBlock(ch_in=32, ch_out=64, k_size=3, s_size=1, p_size=1)
            self.convblock3_1 = sc.ConvBlock(ch_in=64, ch_out=64, k_size=3, s_size=1, p_size=1)

            self.convblock4 = sc.ConvBlock(ch_in=64, ch_out=64, k_size=3, s_size=1, p_size=1)
            self.convblock4_1 = sc.ConvBlock(ch_in=64, ch_out=64, k_size=3, s_size=1, p_size=1)
            ...
            #-----------------------------------------------------------------------
            self.convblock5 = sc.ConvBlock(ch_in=64, ch_out=128, k_size=3, s_size=1, p_size=1)
            self.convblock5_1 = sc.ConvBlock(ch_in=128, ch_out=128, k_size=3, s_size=1, p_size=1)

            self.convblock6 = sc.ConvBlock(ch_in=128, ch_out=128, k_size=3, s_size=1, p_size=1)
            self.convblock6_1 = sc.ConvBlock(ch_in=128, ch_out=128, k_size=3, s_size=1, p_size=1)
            # mapping conv
            ...
            #-----------------------------------------------------------------------
            self.convblock7 = sc.ConvBlock(ch_in=128, ch_out=256, k_size=3, s_size=1, p_size=1)
            self.convblock7_1 = sc.ConvBlock(ch_in=256, ch_out=256, k_size=3, s_size=1, p_size=1)

            self.convblock8 = sc.ConvBlock(ch_in=256, ch_out=256, k_size=3, s_size=1, p_size=1)
            self.convblock8_1 = sc.ConvBlock(ch_in=256, ch_out=256, k_size=3, s_size=1, p_size=1)
            ...
            #-----------------------------------------------------------------------
            self.convblock9 = sc.ConvBlock(ch_in=256, ch_out=512, k_size=3, s_size=1, p_size=1)
            self.convblock9_1 = sc.ConvBlock(ch_in=512, ch_out=512, k_size=3, s_size=1, p_size=1)

            self.convblock10 = sc.ConvBlock(ch_in=512, ch_out=512, k_size=3, s_size=1, p_size=1)
            self.convblock10_1 = sc.ConvBlock(ch_in=512, ch_out=512, k_size=3, s_size=1, p_size=1)
