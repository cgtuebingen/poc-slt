...
def extract_remeshed_meshes_file_name_from_mesh_file_name(
    mesh_file_name: str, remeshed_mesh_path: str
) -> str:
...
def extract_original_meshes_file_name_from_mesh_file_name(
    mesh_file_name: str, orig_mesh_path: str
) -> str:
    common_pattern1 = "/graphics/scratch2/staff/zakeri/LMDBs/ShapeNetCorev2_remeshed_0.008/ShapeNetCore.v2/"
