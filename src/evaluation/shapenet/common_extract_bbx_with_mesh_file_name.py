...
def extract_bbx_with_mesh_file_name(mesh_file_name: str, bbx_list: list) -> Tuple[Any, Any]:
...
def calculate_metric_scale_for_mesh_file_name(mesh_file_name: str, bbx_list: list) -> Tuple[Tuple[Any, Any], Tuple[Any, Any]]:
