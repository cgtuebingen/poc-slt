# from Dataset.Dataset_Class_128fullmesh_ABC_with_NonOptimizedLatentCodes_Val import ABCWITHNONOPTIMIZEDLATENTCODES
import trimesh
...
#     lmdb_path = "/graphics/scratch2/staff/zakeri/LMDBs/ABC_128cube_5KLMDB_Test_with_nonOptimizedLatentCodes/"
#     value_range = 1
#     resolution = 128
#
#     dataset = ABCWITHNONOPTIMIZEDLATENTCODES(obj_dir, lmdb_path, value_range, resolution)
#
#     return dataset
