...
class EVALABC:
    ...
    def assign_constant_learnable_tensors(self, optimized_latent_codes: torch.Tensor, bool_dict: dict) -> torch.Tensor:
        ...
        masked_optimized_latent_codes[mask_all_bool] = self.frozen_constant_learnable_mask_tensors

        return masked_optimized_latent_codes.clone()

    def forward_ABC(self, sub_voxels: torch.Tensor, non_optimized_latent_codes: torch.Tensor, mask_all_bool) -> Union[tuple[Any, Any, Any], Any]:
    ...
    def evaluate_val(self):
        ...
        val_dataset = setup_dataset(self.obj_dir, self.val_lmdb_path, self.value_range, self.resolution)
