...
def main_half(eval_mode_dir: str, obj_dir: str, common_obj_dir: str, checkpoint_mode_path: str):
    ...
    # eval
    parser.add_argument("--masking_ratio", default=0.75, type=float, required=False)
...
if __name__ == "__main__":
    ...
    os.environ["CUDA_VISIBLE_DEVICES"] = "3" # TODO CHANE ME
    ...
    eval_mode_dir = os.path.join(eval_root, "ev0", "MR0.75/")
